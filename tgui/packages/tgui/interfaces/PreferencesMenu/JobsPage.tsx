        ...
        <Stack.Item>
          <Stack fill className="PreferencesMenu__Jobs">
            <Stack.Item mr={1}>
              ...
              <Department department="Инженерия">
                <Gap amount={6} />
              </Department>

              <Department department="Наука">
                <Gap amount={6} />
              </Department>

              <Department department="ИИ">
                <Gap amount={12} />
              </Department>

              <Department department="Ассистент" />
            </Stack.Item>

            <Stack.Item mr={1}>
              <PriorityHeaders />

              <Department department="Капитан">
                <Gap amount={6} />
              </Department>

              <Department department="Сервис">
                <Gap amount={6} />
              </Department>

              <Department department="Грузы" />
            </Stack.Item>
            ...
            <Stack.Item>
              ...
              <Department department="Охрана">
                <Gap amount={6} />
              </Department>

              <Department department="Медицина" />
            </Stack.Item>
          </Stack>
        </Stack.Item>
      </Stack>
