...
/datum/round_event/stray_cargo/announce(fake)
	...
	priority_announce("Блуждающая грузовая капсула обнаружена на сканерах дальнего действия. Ожидаемое место столкновения: [impact_area.name].", "Предупреждение о столкновении")
