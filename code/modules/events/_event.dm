...
/datum/round_event/proc/announce_deadchat(random, cause)
	deadchat_broadcast(" только что был[random ? " случайно" : ""] инициирован[cause ? " [cause]" : ""]!", "<b>[control.name]</b>", message_type=DEADCHAT_ANNOUNCEMENT) //STOP ASSUMING IT'S BADMINS!
