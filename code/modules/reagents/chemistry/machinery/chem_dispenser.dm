...
/obj/machinery/chem_dispenser/drinks/fullupgrade //fully ugpraded stock parts, emagged
	desc = "Содержит большой резервуар для безалкогольных напитков. В данной модели произошло короткое замыкание."
...
/obj/machinery/chem_dispenser/drinks/beer/fullupgrade //fully ugpraded stock parts, emagged
	desc = "Содержит большое количество полезных ингредиентов. У этой модели произошло короткое замыкание."
	obj_flags = CAN_BE_HIT | EMAGGED | NO_DECONSTRUCTION
