/datum/job/research_director
	...
	description = "Контролировать исследовательские работы, следить за тем, чтобы робототехника была \
		в рабочем состоянии. Следить за тем, чтобы ИИ и его Киборги не были неконтролируемыми, заменять их если они \
		выходят из подконтроля."
