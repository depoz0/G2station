/datum/job/lawyer
	title = JOB_LAWYER
	description = "Защищайте интересы заключенных, создавайте контракты, имеющие юридическую силу,\
		следить за тем, чтобы служба безопасности соблюдала протокол и космическое право."
