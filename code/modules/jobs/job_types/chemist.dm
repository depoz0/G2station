/datum/job/chemist
	title = JOB_CHEMIST
	description = "Обеспечивайте врачей химикатами, изготавливайте лекарства, а также \
		менее приятные субстанции в комфортных условиях полностью укрепленного помещения."
