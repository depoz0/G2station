...
#define LOCATION_LPOCKET "в вашем левом кармане"
/// String for items placed into the right pocket
#define LOCATION_RPOCKET "в вашем правом кармане"
/// String for items placed into the backpack.
#define LOCATION_BACKPACK "в вашем рюкзаке"
/// String for items placed into the hands.
#define LOCATION_HANDS "в ваших руках"
/// String for items placed in the glove slot.
#define LOCATION_GLOVES "на ваших руках"
...
#define LOCATION_HEAD "на вашей голове"
/// String for items placed in the neck slot.
#define LOCATION_NECK "на вашей шее"
