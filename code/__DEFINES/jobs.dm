...
#define JOB_ERT_COMMANDER "Отряд быстрого реагирования"
...
#define JOB_CENTCOM_ADMIRAL "Адмирал"
#define JOB_CENTCOM_COMMANDER "CentCom Commander"
#define JOB_CENTCOM_VIP "VIP-гость"
...
#define SUPERVISOR_CAPTAIN "Капитан"
#define SUPERVISOR_CE "Главный инженер"
#define SUPERVISOR_CMO "Главный врач"
#define SUPERVISOR_HOP "Глава персонала"
#define SUPERVISOR_HOS "Глава службы безопасности"
#define SUPERVISOR_QM "Квартирмейстер"
#define SUPERVISOR_RD "Директор исследований"
