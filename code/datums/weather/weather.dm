...
/datum/weather
	...
	var/desc = "Сильные порывы ветра настигают регион, периодически сбивая с ног всех, кто оказался на открытом пространстве."
	/// The message displayed in chat to foreshadow the weather's beginning
	var/telegraph_message = "<span class='warning'>Ветер начинает усиливаться.</span>"
	...
	var/weather_message = "<span class='userdanger'>Ветер начинает неистово выть!</span>"
	...
	var/end_message = "<span class='danger'>Ветер ослабляет силу своего порыва.</span>"
