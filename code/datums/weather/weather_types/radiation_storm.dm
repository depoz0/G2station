...
/datum/weather/rad_storm
	...
	desc = "Облако интенсивного излучения проходит через участок, нанося радикальный урон тем, кто не защищен."

	telegraph_duration = 400
	telegraph_message = "<span class='danger'>Воздух начинает нагреваться.</span>"

	weather_message = "<span class='userdanger'><i>Вы чувствуете, как на вас накатывают волны жара! Найдите укрытие!</i></span>"
...
/datum/weather/rad_storm/end()
	if(..())
		return
	priority_announce("Радиационная угроза миновала. Пожалуйста, возвращайтесь на свои рабочие места.", "Предупреждение об аномалии")
	status_alarm(FALSE)
